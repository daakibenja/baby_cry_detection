...
def main():
    ...
    parser.add_argument(
        '--file_name', default='V_2017-04-01+08_04_36=0_13.mp3')
    ...
    stop = timeit.default_timer()
    logging.info(
        'Time taken for feature engineering: {0}'.format(stop - start))
    ...
    stop = timeit.default_timer()
    logging.info('Time taken for prediction: {0}. Is it a baby cry?? {1}'.format(
